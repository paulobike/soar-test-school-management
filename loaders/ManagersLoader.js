...
const AuditLogManager       = require('../managers/entities/auditLog/AuditLog.manager');
...
const TransferRequestManager = require('../managers/entities/transferRequest/TransferRequest.manager');
...
module.exports = class ManagersLoader {
    ...
    load() {
        ...
        this.managers.auditLog            = new AuditLogManager(this.injectable);
        ...
        this.managers.transferRequest     = new TransferRequestManager(this.injectable);
        /*************************************************************************************************/
